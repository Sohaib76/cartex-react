      ...
      <div className=" w-full ">
        ...
        <div className="absolute top-[110px] md:top-[200px] w-full">
          <div className="md:w-[60%] lg:w-[45%]  w-11/12  text-white text-center inset-x-0 mx-auto  ">
            <div className="absolute text-2xl md:text-5xl mt-2 inset-x-0 -top-[27px]  md:-top-[45px] font-bold  z-20 ">
              Welcome to Our Blog{" "}
            </div>
            ...
            <div className="text-lg md:text-3xl font-bold">
              Stay updated with the latest news, stories and insights shared by
              the CarterX Team.
            </div>
          </div>
        </div>
        ...
        <div className="w-full mt-10 md:mt-20">
          <div className="w-full md:w-11/12 lg:w-10/12 mt-0 md:mt-10 mx-auto">
            <h2 className="text-2xl md:text-4xl w-11/12  font-bold pb-10">
              Featured
            </h2>
            <div className="flex flex-col-reverse md:flex-row w-full md:gap-5 lg:gap-10 py-2">
              <div className="flex flex-col w-11/12 mx-auto md:w-8/12 ">
                ...
                <h2 className=" text-2xl md:text-4xl font-bold py-5">
                  Trending
                </h2>
