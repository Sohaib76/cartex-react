      ...
      <div className="flex flex-col  gap-3 w-full px-2 md:w-10/12 md:mx-auto pt-12">
        ...
        <div className="bg-white rounded-2xl p-4 md:p-8 flex flex-col gap-5 mb-6 ">
          ...
          <div className="flex flex-col text-lg gap-2 font-normal ">
            <p>
              Booking address can be modified upto 24 hours prior to the slot
              time
            </p>
            <p>
            ...
            <p>
              No charges for excess weight are levied for Arrival passengers
            </p>
            ...
            <div className="py-6 flex flex-col gap-2">
              <p>
                Arrival from 12am - 3pm | Same day delivery between 5pm –
                11.55pm
              </p>
            ...
            <p>
              All bags of each order will be delivered at the doorstep to
              minimise exposure. Passenger/household personnel should continue
              to wear mask while interacting with CarterX personnel at delivery
