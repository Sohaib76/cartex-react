          ...
          <Card css=" w-full lg:w-3/4 min-h-[348px]">
            <div className="flex flex-col pt-4 justify-center items-center md:justify-start md:items-center">
              <div className="flex items-center justify-center relative cursor-pointer">
                <img
                  className=" p-0 brightness-50 h-[180px] "
                ...
                <div className=" absolute  text-center  ">
                  {" "}
                  <CameraAltOutlinedIcon className="text-white text-center " />
                </div>
              </div>
              <div
                className="text-[17px] text-[#1A7DC1] font-bold py-3 pl-3 z-30 cursor-pointer  "
                onClick={handleClick}
              >
                Change Photo
              </div>
              <div
                className="text-[17px] text-[#FF0000] font-bold pb-5 pl-3 cursor-pointer "
                onClick={() => setNewItem("")}
              >
                Remove Photo
              </div>
            ...
            <div className="flex flex-col md:w-8/12 w-full md:mx-auto  gap-4">
              <div className="rounded-lg border-[#CCCCCC]  border-2 w-full md:w-3/4 px-2">
                ...
                <p
                  className="font-bold text-2xl border-[#fff] outline-0"
              ...
              <div className="rounded-lg border-[#CCCCCC]  border-2 w-full md:w-3/4 px-2 py-2">
                ...
                <p
                  className="font-bold text-2xl outline-0"
                  contentEditable={true}
                >
              ...
              <div className="flex flex-col justify-center items-center gap-2 md:w-3/4">
                <div
                  className="bg-[#F47521] rounded-3xl text-center text-white w-[250px] md:w-[340px] h-[48px] flex justify-center items-center cursor-pointer"
                  onClick={saveImageHandler}
                >
                  Save Changes{" "}
                </div>
                <div
                  className=" rounded-3xl text-center text-[#F47521] w-[170px] px-2 py-3 cursor-pointer"
