...
function Footer() {
  ...
  return (
    <div className=" bg-white py-5 w-full overflow-hidden drop-shadow-[0_35px_35px_rgba(0,0,0,0.5)] ">
      <img
        className="mx-auto justify-center w-[280px] md:w-[302px] h-[48px]"
        src={Cartex}
        alt="Cartex logo"
      ></img>
      <br />
      ...
      <hr />
      <div className="mx-auto text-lg pt-5 md:text-xl text-[#919191] w-full text-center ">
        ©CarterX All rights reserved
      </div>
    </div>
  );
}
