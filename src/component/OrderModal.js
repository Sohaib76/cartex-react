      ...
      <div className="flex flex-col justify-center items-center gap-3">
        ...
        <div className="flex flex-row gap-2  text-center">
          <div className="flex flex-col">
            <img
              className="w-[40px] md:w-[52px] h-[40px] md:h-[52px] bg-[#FDE3D2] p-3 rounded-full"
              src={medal}
            ></img>
          ...
          <div className="flex flex-col">
            <img
              className="w-[40px] md:w-[52px] h-[40px] md:h-[52px] bg-[#FDE3D2] p-2 md:p-3 rounded-full"
              src={money}
            ></img>
            <div className="text-[10px] md:text-sm">
              Value for
        ...
        <div className="rounded-lg border-[#CCCCCC]  border-2  px-2 w-[250px] md:w-[352px] h-[170px] md:h-[200px]">
          ...
          <textarea
            className="text:lg md:text-2xl border-[#fff] text-[#707070] w-full h-[140px] md:h-[170px] outline-0"
